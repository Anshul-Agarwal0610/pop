...
describe("AchievementCard",()=>{
 it("explains a locked achievement in text",()=>{render(<AchievementCard achievement={base}/>);expect(screen.getByLabelText("Explorer: locked")).toHaveTextContent("Unlock: Vote in 3 categories")})
